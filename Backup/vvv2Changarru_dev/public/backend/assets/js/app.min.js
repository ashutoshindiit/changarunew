...
function(e) {
    ...
    t.prototype.initControls = function() {
        ...
        window.sessionStorage && t && t.hasOwnProperty("showRightSidebarOnPageLoad") && t.showRightSidebarOnPageLoad && (sessionStorage.getItem("_BG_VISITED_") || (e.RightBar.toggleRightSideBar(), sessionStorage.setItem("_BG_VISITED_", !0)))
