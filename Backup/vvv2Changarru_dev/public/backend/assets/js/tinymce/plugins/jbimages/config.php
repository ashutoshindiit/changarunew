...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '../img/editor'; // Relative to domain name
//** for server 	'/home/autoplus/public_html/app/webroot/img/editor'; //
       $config['upload_path'] =  '/opt/lampp/htdocs/zportix/webroot/img/editor'; // Physical path. [Usually works fine like this]
