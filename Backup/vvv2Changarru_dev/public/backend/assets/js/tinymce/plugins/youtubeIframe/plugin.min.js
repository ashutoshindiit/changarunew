...
var YoutubeDialog = {
    ...
    insert: function () {
        ...
        <object width="'+width+'" height="'+height+'">\n\
            <param name="movie" value="http://www.youtube.com/v/'+code+'?wmode=transparent"></param>\n\
            <param name="allowFullScreen" value="true"></param>\n\
            <param name="allowscriptaccess" value="always"></param>\n\
            <param name="wmode" value="transparent"></param>\n\
            <embed src="http://www.youtube.com/v/'+code+'?wmode=transparent" type="application/x-shockwave-flash" width="'+width+'" height="'+height+'" allowscriptaccess="always" allowfullscreen="true"></embed>\n\
        </object>';
