    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6">
                ...
                <img src="{{asset('public/frontend/landingPage/images/logo-1.png')}}" class="img-fluid" alt="" />
                <p>Changarru provides progressive, and affordable healthcare, accessible on mobile and online for everyone</p>
            </div>
            <div class="col-lg-3 col-md-6">
                <h3>Company</h3>
                <ul>
            ...
            <div class="col-lg-3 col-md-6">
                <h3>Region</h3>
                <ul>
                    <li> <a href="#">Stores Directory</a></li>
