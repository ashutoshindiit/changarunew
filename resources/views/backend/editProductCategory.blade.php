            ...
            <div class="col-12">
               <div class="card">
                  <div class="card-body">
                     <div class="row">
                        <div class="col-lg-12">
                           <div class="d-flex align-items-center justify-content-between">
                              <h4 class="header-title mb-3 pull-left">Edit Product Category</h4>
                     ...
                     <form id="productCategoryImageForm" action="{{url('admin/productManagement/category/edit-category/'.$id)}}" method="post"  enctype="multipart/form-data" >
                        @csrf
                           <div class="row mb-3">
                              <div class="col-lg-6">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="name" value="{{$sellerCategories['name']}}" class="form-control" />
                              </div>
                              ...
                              <div class="form-group mb-3">
                                 ...
                                 <div class="input-group">
                                    <select class="form-control custom-select" name="seller_id" value="" required="">
                                       ...
                                       <option value="{{@$value->id}}"  @if($value['id']==$sellerCategories['seller_id']) selected @endif>{{@$value->buisness_name}} ({{@$value->slug}})</option>
                                       @endforeach              
                                    </select>
                                 </div>
                              </div>
